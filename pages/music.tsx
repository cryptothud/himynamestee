      ...
      <div className="max-w-full w-full flex flex-col items-center gap-8" data-aos="fade" data-aos-duration="500">
        <div className="flex gap-2 justify-center my-3">
          <a href="https://music.apple.com/us/artist/tee/1458672658" target="_blank">
            <ImageWithProxyFallback src="/images/music.png" alt="Apple Music" width="611" height="193" className="w-40 max-w-[30vw] cursor-pointer hover:opacity-40 duration-300" />
          </a>
          <a href="https://open.spotify.com/artist/5cdrxr9s52oZCf78xOLa4R?utm_medium=share&utm_source=linktree" target="_blank">
            <ImageWithProxyFallback src="/images/spotify.png" alt="Spotify" width="611" height="193" className="w-40 max-w-[30vw] cursor-pointer hover:opacity-40 duration-300" />
          </a>
          <a href="https://audiomack.com/himynamestee" target="_blank">
            <ImageWithProxyFallback src="/images/audiomack.png" alt="Spotify" width="611" height="193" className="w-40 max-w-[30vw] cursor-pointer hover:opacity-40 duration-300" />
          </a>
        </div>
